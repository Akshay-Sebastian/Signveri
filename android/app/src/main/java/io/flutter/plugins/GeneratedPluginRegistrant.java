...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new io.fynn.pytorch_mobile.PyTorchMobilePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin pytorch_mobile, io.fynn.pytorch_mobile.PyTorchMobilePlugin", e);
    }
  }
}
